import{i as a,p as o,n as r,V as n}from"./index-CcpPQMlK.js";import{r as i}from"./index-DF3CcTcq.js";const l=a(o.div)`
...
`,p=({text:e,lang:t="en-US",size:s})=>r.jsx(l,{"data-testid":"comp-speak-icon",$size:s,onClick:()=>i(e,t),whileHover:{scale:1.1},whileTap:{scale:.95},role:"button","aria-label":e.length<=2?e:"Read text",children:r.jsx(n,{strokeWidth:2.5})});export{p as S};
