import{am as o,i as r,p as l,n as s,K as n,an as c,x as d,ao as h,r as g,s as p,t as x}from"./index-S6EAxzK5.js";function w(e,t="en-US"){if(o.getState().alphabet.isMuted)return;window.speechSynthesis.cancel();const i=new SpeechSynthesisUtterance(e);i.lang=t,i.rate=.95,i.pitch=1.1,window.speechSynthesis.speak(i)}const y=e=>{const t=["Good Start","Keep Going","Well Done","So Smart","Half Way","Great Job","Amazing","Brilliant","Nearly There","Almost Done"];return e<0?"Keep going":t[e%t.length]},m=r(l.div)`
