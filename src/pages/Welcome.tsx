...
const Welcome: React.FC = () => {
  ...
  return (
    <PageContainer>
      <PageHeader>
        <PageTitle>
          Hi there! <motion.span animate={{ rotate: [0, 20, 0] }} transition={{ repeat: Infinity, duration: 2 }} style={{ display: 'inline-block' }}>👋</motion.span>
        </PageTitle>
        <PageSubtitle>
      ...
      <Card style={{ 
        ...
        <p style={{ fontSize: "1.2rem", marginBottom: "30px", opacity: 0.9, maxWidth: "500px", margin: "0 auto 30px" }}>
